...
sap.ui.require(
  [
    ...
    "project1/test/integration/PurchaseOrderHeadersListJourney",
    "project1/test/integration/PurchaseOrderHeadersObjectPageJourney",
    "project1/test/integration/PurchaseOrderItemsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
